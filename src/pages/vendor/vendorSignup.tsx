...
export default function VendorSignup() {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        const errorMessage = data.username?.[0] || data.email?.[0] || data.message || Object.values(data)[0]?.[0] || "Failed to register";
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 flex flex-col items-center">
              ...
              <Button
                ...
                disabled={!email || !username || !password || !confirmPassword || password !== confirmPassword || !agreeToTerms || isLoading}
                className="w-80 mx-auto bg-blue-600 hover:bg-blue-700"
              >
                {isLoading ? "Creating Account..." : "Join as Seller"}
              </Button>
            </div>
          </div>
        )}
